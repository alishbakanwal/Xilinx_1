...
#
# FILE: pa_cg_gen_core.tcl
#
# This script generates a coregen core
#

source "$tclUtilsPath"

#######################################
# Generate CORE Generator 2.0 IP core #
#######################################
...
if { $designID eq "" } {
   ...
   if { $ipType eq "SPIRIT" } {
      ...
      # access the migrated or existing component instance in project
