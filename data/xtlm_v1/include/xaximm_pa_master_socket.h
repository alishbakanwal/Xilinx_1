...
namespace xtlm_v1{
  ...
  public:
    ...
    void bind(xtlm_v1::xtlm_initiator_socket& p_wr_master_socket,
        xtlm_v1::xtlm_initiator_socket& p_rd_master_socket);
    void bind(xtlm_v1::xtlm_simple_initiator_socket_tagged& p_wr_master_socket,
        xtlm_v1::xtlm_simple_initiator_socket_tagged& p_rd_master_socket);
    void simulate_single_cycle();
