...
#include <vector>
#define SC_ID_IEEE_1666_DEPRECATION_CUSTOM "/IEEE_Std_1666/deprecated"
namespace sc_core {
...
sc_elab_and_sim( int argc, char* argv[] )
{
    ...
    if ( sc_report_handler::get_count( SC_ID_IEEE_1666_DEPRECATION_CUSTOM ) > 0 )
    {
        std::stringstream ss;
...
#       define CODENL "\n  "
        ...
        ss <<
          ...
          "\"" << SC_ID_IEEE_1666_DEPRECATION_CUSTOM << "\"," CODENL
          "                                         " /* indent param */
          "sc_core::SC_DO_NOTHING );"
          << std::endl;

        SC_REPORT_INFO( SC_ID_IEEE_1666_DEPRECATION_CUSTOM, ss.str().c_str() );
    }
