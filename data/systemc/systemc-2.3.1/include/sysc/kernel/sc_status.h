...
SC_EXPORT const int SC_SIM_OK        = 0;
SC_EXPORT const int SC_SIM_ERROR     = 1;
SC_EXPORT const int SC_SIM_USER_STOP = 2;
...
SC_EXPORT std::ostream& operator << ( std::ostream&, sc_status );
