...
struct SC_EXPORT sc_bind_proxy
{
    sc_interface* iface;
    sc_port_base* port;
...
SC_EXPORT extern const sc_bind_proxy SC_BIND_PROXY_NIL;
...
SC_EXPORT extern sc_module* sc_module_dynalloc(sc_module*);
