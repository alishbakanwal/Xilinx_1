...
// friend function declarations
    SC_EXPORT int sc_notify_time_compare( const void*, const void* );
...
class SC_EXPORT sc_event_and_list
...
class SC_EXPORT sc_event_or_list
: public sc_event_list
{
    friend class sc_event;
...
SC_EXPORT extern sc_event sc_non_event; // Event that never happens.
...
class SC_EXPORT sc_event_timed
{
    friend class sc_event;
    friend class sc_simcontext;
...
SC_EXPORT extern void notify( sc_event& e );
SC_EXPORT extern void notify( const sc_time& t, sc_event& e );
SC_EXPORT extern void notify( double v, sc_time_unit tu, sc_event& e );
