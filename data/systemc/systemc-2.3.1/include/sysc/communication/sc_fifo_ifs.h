...
template <class T> 
class SC_EXPORT sc_fifo_nonblocking_in_if 
...
template <class T> 
class SC_EXPORT sc_fifo_blocking_in_if 
: virtual public sc_interface 
{ 
public: 
...
template <class T> 
class SC_EXPORT sc_fifo_nonblocking_out_if 
: virtual public sc_interface 
{ 
public: 
...
template <class T> 
class SC_EXPORT sc_fifo_blocking_out_if 
: virtual public sc_interface 
{ 
public: 
...
template <class T> 
class SC_EXPORT sc_fifo_out_if 
