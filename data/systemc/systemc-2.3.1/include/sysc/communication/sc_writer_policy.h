...
SC_EXPORT enum sc_writer_policy
{
...
struct SC_EXPORT sc_writer_policy_nocheck_write
{
...
struct SC_EXPORT sc_writer_policy_check_write
{
  bool check_write( sc_object* target, bool value_changed );
  void update(){}
protected:
...
struct SC_EXPORT sc_writer_policy_check_delta
...
struct SC_EXPORT sc_writer_policy_nocheck_port
{
  bool check_port( sc_object*, sc_port_base*, bool )
    { return true; }
};

struct SC_EXPORT sc_writer_policy_check_port
{
