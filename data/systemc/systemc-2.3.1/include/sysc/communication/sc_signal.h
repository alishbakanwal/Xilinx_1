...
SC_EXPORT extern void sc_deprecated_get_data_ref();
SC_EXPORT extern void sc_deprecated_get_new_value();
SC_EXPORT extern void sc_deprecated_trace();
SC_EXPORT extern sc_event * sc_lazy_kernel_event( sc_event**, const char* name );
