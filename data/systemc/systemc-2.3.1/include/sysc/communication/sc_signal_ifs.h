...
template <class T>
class SC_EXPORT sc_signal_in_if
...
template <>
class SC_EXPORT sc_signal_in_if<bool>
: virtual public sc_interface
{
...
template <>
class SC_EXPORT sc_signal_in_if<sc_dt::sc_logic>
: virtual public sc_interface
{
public:
...
// ----------------------------------------------------------------------------
template< typename T >
class SC_EXPORT sc_signal_write_if : public virtual sc_interface
{
public:
    sc_signal_write_if() {}
    // write the new value
...
template <class T>
class SC_EXPORT sc_signal_inout_if
