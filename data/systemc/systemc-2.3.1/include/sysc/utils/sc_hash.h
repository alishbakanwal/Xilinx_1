...
#ifdef _WIN32
#ifdef SC_HASH_CPP
#define SC_HASH_SYM SC_EXPORT
#else
#define SC_HASH_SYM SC_IMPORT
#endif
#else
#define SC_HASH_SYM
#endif
...
SC_HASH_SYM extern unsigned default_int_hash_fn(const void*);
SC_HASH_SYM extern unsigned default_ptr_hash_fn(const void*);
SC_HASH_SYM extern unsigned default_str_hash_fn(const void*);
...
SC_HASH_SYM extern const double PHASH_DEFAULT_GROW_FACTOR;
const bool   PHASH_DEFAULT_REORDER_FLAG    = true;

class SC_HASH_SYM sc_phash_base {
...
class SC_HASH_SYM sc_phash_base_iter {
protected:
    sc_phash_base*  table;
    sc_phash_elem*  entry;
    sc_phash_elem*  next;
...
SC_HASH_SYM extern int sc_strhash_cmp( const void*, const void* );
SC_HASH_SYM extern void sc_strhash_kfree(void*);
SC_HASH_SYM extern void* sc_strhash_kdup(const void*);
