...
class SC_EXPORT sc_plist_base_iter {
public:
    typedef sc_plist_elem* handle_t;
...
template< class T >
class SC_EXPORT sc_plist : public sc_plist_base {
...
template< class T >
class SC_EXPORT sc_plist_iter : public sc_plist_base_iter {
public:
