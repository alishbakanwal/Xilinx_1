...
// ----------------------------------------------------------------------------
#ifdef _WIN32
#ifdef SC_CONCATREF_CPP
#define SC_CONCAT_BOOL_SYM SC_EXPORT
#else
#define SC_CONCAT_BOOL_SYM SC_IMPORT
#endif
#else
#define SC_CONCAT_BOOL_SYM
#endif
class SC_CONCAT_BOOL_SYM sc_concatref : public sc_generic_base<sc_concatref>, public sc_value_base
{
public:
...
class SC_CONCAT_BOOL_SYM sc_concat_bool : public sc_value_base
{
  protected:
