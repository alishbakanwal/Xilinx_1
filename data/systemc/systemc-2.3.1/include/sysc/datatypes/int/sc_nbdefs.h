...
#ifdef _WIN32
#ifdef SC_NBDEFS_CPP
#define SC_NBDEFS_SYM SC_EXPORT
#else
#define SC_NBDEFS_SYM SC_IMPORT
#endif
#else
#define SC_NBDEFS_SYM 
#endif
...
#ifdef SC_MAX_NBITS
SC_NBDEFS_SYM extern const int MAX_NDIGITS;
...
#   endif
    SC_NBDEFS_SYM extern const uint64        UINT64_ZERO;
    SC_NBDEFS_SYM extern const uint64        UINT64_ONE;
    SC_NBDEFS_SYM extern const uint64        UINT64_32ONES;
#else
...
SC_NBDEFS_SYM extern const small_type NB_DEFAULT_BASE ;
...
SC_NBDEFS_SYM extern const uint64 UINT_ZERO;
SC_NBDEFS_SYM extern const uint64 UINT_ONE;
...
SC_NBDEFS_SYM extern const unsigned int UINT_ZERO;
SC_NBDEFS_SYM extern const unsigned int UINT_ONE;
