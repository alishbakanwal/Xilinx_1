...
SC_EXPORT void multiply( scfx_rep&, const scfx_rep&, const scfx_rep&, 
	       int max_wl = SC_DEFAULT_MAX_WL_ );
SC_EXPORT scfx_rep*  neg_scfx_rep( const scfx_rep& );
SC_EXPORT scfx_rep*  mult_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                  int max_wl = SC_DEFAULT_MAX_WL_ );
SC_EXPORT scfx_rep*  div_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                 int max_wl = SC_DEFAULT_DIV_WL_ );
SC_EXPORT scfx_rep*  add_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                 int max_wl = SC_DEFAULT_MAX_WL_ );
SC_EXPORT scfx_rep*  sub_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                 int max_wl = SC_DEFAULT_MAX_WL_ );
SC_EXPORT scfx_rep*  lsh_scfx_rep( const scfx_rep&, int );
SC_EXPORT scfx_rep*  rsh_scfx_rep( const scfx_rep&, int );
SC_EXPORT int        cmp_scfx_rep( const scfx_rep&, const scfx_rep& );


SC_EXPORT const int min_mant = 4;

SC_EXPORT const int bits_in_int  = sizeof(int)  * CHAR_BIT;
SC_EXPORT const int bits_in_word = sizeof(word) * CHAR_BIT;
