...
class SC_EXPORT sc_fxnum_bitref
{
...
class SC_EXPORT sc_fxnum_fast_bitref
{
...
class SC_EXPORT sc_fxnum_subref
{
    friend class sc_fxnum;
...
class SC_EXPORT sc_fxnum_fast_subref
{
    friend class sc_fxnum_fast;
