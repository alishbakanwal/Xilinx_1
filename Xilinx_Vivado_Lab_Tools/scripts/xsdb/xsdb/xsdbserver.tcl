...
SYNOPSIS {
    xsdbserver start [options]
        ...
        commands.  The XSDB server reads commands from from the
...
RETURNS {
    ...
    successfully, or errot string, if a server has been already started.
}
EXAMPLE {
    xsdbserver start
    ...
    xsdbserver start -host localhost -port 2000
        ...
        incomming connections this host
}
}
...
RETURNS {
    ...
    ::xsdb::setcmdmeta {xsdbserver disconnect} brief {Disconnect current XSDB server connection}
