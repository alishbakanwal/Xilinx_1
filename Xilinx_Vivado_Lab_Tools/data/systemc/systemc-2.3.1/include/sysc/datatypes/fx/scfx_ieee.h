...
SC_EXPORT const unsigned int SCFX_IEEE_DOUBLE_BIAS   =  1023U;

SC_EXPORT const int          SCFX_IEEE_DOUBLE_E_MAX  =  1023;
SC_EXPORT const int          SCFX_IEEE_DOUBLE_E_MIN  = -1022;

SC_EXPORT const unsigned int SCFX_IEEE_DOUBLE_M_SIZE  =    52;
SC_EXPORT const unsigned int SCFX_IEEE_DOUBLE_M0_SIZE =    20;
SC_EXPORT const unsigned int SCFX_IEEE_DOUBLE_M1_SIZE =    32;
SC_EXPORT const unsigned int SCFX_IEEE_DOUBLE_E_SIZE  =    11;
...
class SC_EXPORT scfx_ieee_double
{
