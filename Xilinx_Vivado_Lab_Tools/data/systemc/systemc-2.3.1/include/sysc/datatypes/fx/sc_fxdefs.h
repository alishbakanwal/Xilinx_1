...
SC_EXPORT const std::string to_string( sc_enc );
...
SC_EXPORT const std::string to_string( sc_q_mode );
...
SC_EXPORT const std::string to_string( sc_o_mode );
...
SC_EXPORT const std::string to_string( sc_switch );
...
SC_EXPORT const std::string to_string( sc_fmt );
...
SC_EXPORT const int       SC_BUILTIN_WL_     = 32;
SC_EXPORT const int       SC_BUILTIN_IWL_    = 32;
SC_EXPORT const sc_q_mode SC_BUILTIN_Q_MODE_ = SC_TRN;
SC_EXPORT const sc_o_mode SC_BUILTIN_O_MODE_ = SC_WRAP;
SC_EXPORT const int       SC_BUILTIN_N_BITS_ = 0;


SC_EXPORT const int       SC_DEFAULT_WL_     = SC_BUILTIN_WL_;
SC_EXPORT const int       SC_DEFAULT_IWL_    = SC_BUILTIN_IWL_;
SC_EXPORT const sc_q_mode SC_DEFAULT_Q_MODE_ = SC_BUILTIN_Q_MODE_;
SC_EXPORT const sc_o_mode SC_DEFAULT_O_MODE_ = SC_BUILTIN_O_MODE_;
SC_EXPORT const int       SC_DEFAULT_N_BITS_ = SC_BUILTIN_N_BITS_;
...
SC_EXPORT const sc_switch SC_BUILTIN_CAST_SWITCH_ = SC_ON;


SC_EXPORT const sc_switch SC_DEFAULT_CAST_SWITCH_ = SC_BUILTIN_CAST_SWITCH_;
...
SC_EXPORT const int SC_BUILTIN_DIV_WL_ = 64;
SC_EXPORT const int SC_BUILTIN_CTE_WL_ = 64;
SC_EXPORT const int SC_BUILTIN_MAX_WL_ = 1024;


#if defined( SC_FXDIV_WL ) && ( SC_FXDIV_WL > 0 )
SC_EXPORT const int SC_DEFAULT_DIV_WL_ = SC_FXDIV_WL;
#else
SC_EXPORT const int SC_DEFAULT_DIV_WL_ = SC_BUILTIN_DIV_WL_;
#endif

#if defined( SC_FXCTE_WL ) && ( SC_FXCTE_WL > 0 )
SC_EXPORT const int SC_DEFAULT_CTE_WL_ = SC_FXCTE_WL;
#else
SC_EXPORT const int SC_DEFAULT_CTE_WL_ = SC_BUILTIN_CTE_WL_;
#endif

#if defined( SC_FXMAX_WL ) && ( SC_FXMAX_WL > 0 || SC_FXMAX_WL == -1 )
SC_EXPORT const int SC_DEFAULT_MAX_WL_ = SC_FXMAX_WL;
#else
SC_EXPORT const int SC_DEFAULT_MAX_WL_ = SC_BUILTIN_MAX_WL_;
#endif
