...
#ifdef _WIN32
#ifdef SC_UNSIGNED_CPP
#define SC_UNSIGNED_SYM SC_EXPORT
#else
#define SC_UNSIGNED_SYM SC_IMPORT
#endif
#else
#define SC_UNSIGNED_SYM 
#endif
...
SC_UNSIGNED_SYM int compare_unsigned(small_type us,
                              int unb,
                              int und,
                              const sc_digit *ud,
                              small_type vs,
...
SC_UNSIGNED_SYM sc_unsigned add_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
SC_UNSIGNED_SYM sc_unsigned sub_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
SC_UNSIGNED_SYM sc_unsigned mul_unsigned_friend(small_type s,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
...
SC_UNSIGNED_SYM sc_unsigned div_unsigned_friend(small_type s,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
...
SC_UNSIGNED_SYM sc_unsigned mod_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
...
SC_UNSIGNED_SYM sc_unsigned and_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
SC_UNSIGNED_SYM sc_unsigned or_unsigned_friend(small_type us,
                                        int unb,
                                        int und,
                                        const sc_digit *ud,
                                        small_type vs,
...
SC_UNSIGNED_SYM sc_unsigned xor_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
// friend operator declarations
  ...
  // ADDition operators:
    ...
    SC_UNSIGNED_SYM sc_signed operator + (const sc_unsigned&  u, const sc_signed&    v);
    SC_UNSIGNED_SYM sc_signed operator + (const sc_signed&    u, const sc_unsigned&  v);

    SC_UNSIGNED_SYM sc_unsigned operator + (const sc_unsigned&  u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator + (const sc_unsigned&  u, int64               v);
    SC_UNSIGNED_SYM sc_unsigned operator + (const sc_unsigned&  u, uint64              v);
    SC_UNSIGNED_SYM sc_signed operator + (const sc_unsigned&  u, long                v);
    SC_UNSIGNED_SYM sc_unsigned operator + (const sc_unsigned&  u, unsigned long       v);
    SC_UNSIGNED_SYM sc_signed operator + (const sc_unsigned&  u, int                 v);
  inline sc_unsigned operator + (const sc_unsigned&  u, unsigned int        v);

    SC_UNSIGNED_SYM sc_signed operator + (int64               u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM sc_unsigned operator + (uint64              u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator + (long                u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM sc_unsigned operator + (unsigned long       u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator + (int                 u, const sc_unsigned&  v);
  inline sc_unsigned operator + (unsigned int        u, const sc_unsigned&  v);

  SC_UNSIGNED_SYM sc_unsigned operator + (const sc_unsigned&  u, const sc_uint_base& v);
    SC_UNSIGNED_SYM sc_signed operator + (const sc_unsigned&  u, const sc_int_base&  v);
  SC_UNSIGNED_SYM sc_unsigned operator + (const sc_uint_base& u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator + (const sc_int_base&  u, const sc_unsigned&  v);
  ...
  // SUBtraction operators:
    ...
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, int64               v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, uint64              v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, long                v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, unsigned long       v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, int                 v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, unsigned int        v);

    SC_UNSIGNED_SYM sc_signed operator - (int64               u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (uint64              u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (long                u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (unsigned long       u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (int                 u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (unsigned int        u, const sc_unsigned&  v);

    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, const sc_uint_base& v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned&  u, const sc_int_base&  v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_uint_base& u, const sc_unsigned&  v);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_int_base&  u, const sc_unsigned&  v);
  ...
  SC_UNSIGNED_SYM sc_unsigned operator * (const sc_unsigned&  u, unsigned long       v);
    SC_UNSIGNED_SYM sc_signed operator * (const sc_unsigned&  u, int                 v);
  inline SC_UNSIGNED_SYM sc_unsigned operator * (const sc_unsigned&  u, unsigned int        v);
  ...
  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, const sc_signed&    v);
    SC_UNSIGNED_SYM sc_signed operator << (const sc_signed&    u, const sc_unsigned&  v);

  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, int64               v);
  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, uint64              v);
  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, long                v);
  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, unsigned long       v);
  inline SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, int                 v);
  inline sc_unsigned operator << (const sc_unsigned&  u, unsigned int        v);

  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, const sc_uint_base& v);
  SC_UNSIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, const sc_int_base&  v);
  ...
  SC_UNSIGNED_SYM sc_unsigned operator >> ( const sc_unsigned& , const sc_uint_base& );
  SC_UNSIGNED_SYM sc_unsigned operator >> ( const sc_unsigned&, const sc_int_base& );

  // Unary arithmetic operators
  SC_UNSIGNED_SYM sc_unsigned operator + (const sc_unsigned& u);
    SC_UNSIGNED_SYM sc_signed operator - (const sc_unsigned& u);

  // LOGICAL OPERATORS:

  // Logical EQUAL operators:

  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, const sc_signed&    v);
  SC_UNSIGNED_SYM bool operator == (const sc_signed&    u, const sc_unsigned&  v);

  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, int64               v);
  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, uint64              v);
  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, long                v);
  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, unsigned long       v);
  inline bool operator == (const sc_unsigned&  u, int                 v);
  inline bool operator == (const sc_unsigned&  u, unsigned int        v);

  SC_UNSIGNED_SYM bool operator == (int64               u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM bool operator == (uint64              u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM bool operator == (long                u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM bool operator == (unsigned long       u, const sc_unsigned&  v);
  inline bool operator == (int                 u, const sc_unsigned&  v);
  inline bool operator == (unsigned int        u, const sc_unsigned&  v) ;

  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, const sc_uint_base& v);
  SC_UNSIGNED_SYM bool operator == (const sc_unsigned&  u, const sc_int_base&  v);
  SC_UNSIGNED_SYM bool operator == (const sc_uint_base& u, const sc_unsigned&  v);
  SC_UNSIGNED_SYM bool operator == (const sc_int_base&  u, const sc_unsigned&  v);
...
class SC_UNSIGNED_SYM sc_unsigned_bitref_r : public sc_value_base
{
...
class SC_UNSIGNED_SYM sc_unsigned_bitref
...
class SC_UNSIGNED_SYM sc_unsigned_subref_r : public sc_value_base
{
...
class SC_UNSIGNED_SYM sc_unsigned_subref
...
class SC_UNSIGNED_SYM sc_unsigned : public sc_value_base
{
