...
#ifdef _WIN32
#ifdef SC_INT_BASE_CPP
#define SC_INT_BASE_SYM SC_EXPORT
#else
#define SC_INT_BASE_SYM SC_IMPORT
#endif
#else
#define SC_INT_BASE_SYM
#endif
...
class SC_INT_BASE_SYM sc_int_bitref_r : public sc_value_base
{
...
class SC_INT_BASE_SYM sc_int_bitref
...
class SC_INT_BASE_SYM sc_int_subref_r : public sc_value_base
{
    friend class sc_int_base;
...
class SC_INT_BASE_SYM sc_int_subref
...
class SC_INT_BASE_SYM sc_int_base : public sc_value_base
{
