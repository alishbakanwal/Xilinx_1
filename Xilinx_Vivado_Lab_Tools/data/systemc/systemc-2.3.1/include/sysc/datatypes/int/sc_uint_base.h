...
#ifdef _WIN32
#ifdef SC_UINT_BASE_CPP
#define SC_UINT_BASE_SYM SC_EXPORT
#else
#define SC_UINT_BASE_SYM SC_IMPORT
#endif
#else
#define SC_UINT_BASE_SYM
#endif
...
// friend operator declarations
    SC_UINT_BASE_SYM inline bool operator == ( const sc_uint_base& a, const sc_uint_base& b );
    SC_UINT_BASE_SYM inline bool operator != ( const sc_uint_base& a, const sc_uint_base& b );
    SC_UINT_BASE_SYM inline bool operator <  ( const sc_uint_base& a, const sc_uint_base& b );
    SC_UINT_BASE_SYM inline bool operator <= ( const sc_uint_base& a, const sc_uint_base& b );
    SC_UINT_BASE_SYM inline bool operator >  ( const sc_uint_base& a, const sc_uint_base& b );
...
class SC_UINT_BASE_SYM sc_uint_bitref_r : public sc_value_base
{
...
class SC_UINT_BASE_SYM sc_uint_bitref
...
class SC_UINT_BASE_SYM sc_uint_subref_r : public sc_value_base
{
    friend class sc_uint_base;
...
class SC_UINT_BASE_SYM sc_uint_subref
...
class SC_UINT_BASE_SYM sc_uint_base : public sc_value_base
{
