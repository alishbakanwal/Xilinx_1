...
#ifdef _WIN32
#ifdef SC_SIGNED_CPP
#define SC_SIGNED_SYM SC_EXPORT
#else
#define SC_SIGNED_SYM SC_IMPORT
#endif
#else
#define SC_SIGNED_SYM
#endif
...
SC_SIGNED_SYM sc_signed add_signed_friend(small_type us,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     small_type vs,
...
SC_SIGNED_SYM sc_signed sub_signed_friend(small_type us,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     small_type vs,
...
SC_SIGNED_SYM sc_signed mul_signed_friend(small_type s,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     int vnb,
...
SC_SIGNED_SYM sc_signed div_signed_friend(small_type s,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     int vnb,
...
SC_SIGNED_SYM sc_signed mod_signed_friend(small_type us,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     int vnb,
...
SC_SIGNED_SYM sc_signed and_signed_friend(small_type us,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     small_type vs,
...
SC_SIGNED_SYM sc_signed or_signed_friend(small_type us,
                                    int unb,
                                    int und,
                                    const sc_digit *ud,
                                    small_type vs,
...
SC_SIGNED_SYM sc_signed xor_signed_friend(small_type us,
                                     int unb,
                                     int und,
                                     const sc_digit *ud,
                                     small_type vs,
...
// friend operator declarations
  ...
  SC_SIGNED_SYM sc_signed operator + (const sc_unsigned&  u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, const sc_unsigned&  v);

  SC_SIGNED_SYM sc_signed operator + (const sc_unsigned&  u, int64               v);
  SC_SIGNED_SYM sc_signed operator + (const sc_unsigned&  u, long                v);
  inline sc_signed operator + (const sc_unsigned&  u, int                 v);

  SC_SIGNED_SYM sc_signed operator + (int64               u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator + (long                u, const sc_unsigned&  v);
  inline sc_signed operator + (int                 u, const sc_unsigned&  v);

  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, int64               v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, uint64              v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, long                v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, unsigned long       v);
  inline sc_signed operator + (const sc_signed&    u, int                 v);
  inline sc_signed operator + (const sc_signed&    u, unsigned int        v);

  SC_SIGNED_SYM sc_signed operator + (int64               u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator + (uint64              u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator + (long                u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator + (unsigned long       u, const sc_signed&    v);
  inline sc_signed operator + (int                 u, const sc_signed&    v);
  inline sc_signed operator + (unsigned int        u, const sc_signed&    v);

  SC_SIGNED_SYM sc_signed operator + (const sc_unsigned&  u, const sc_int_base&  v);
  SC_SIGNED_SYM sc_signed operator + (const sc_int_base&  u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, const sc_int_base&  v);
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&    u, const sc_uint_base& v);
  SC_SIGNED_SYM sc_signed operator + (const sc_int_base&  u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator + (const sc_uint_base& u, const sc_signed&    v);
  ...
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, int64               v);
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, uint64              v);
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, long                v);
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, unsigned long       v);
  inline sc_signed operator - (const sc_unsigned&  u, int                v);
  inline sc_signed operator - (const sc_unsigned&  u, unsigned int       v);

  SC_SIGNED_SYM sc_signed operator - (int64               u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator - (uint64              u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator - (long                u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator - (unsigned long       u, const sc_unsigned&  v);
  inline sc_signed operator - (int                 u, const sc_unsigned&  v);
  ...
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, const sc_int_base&  v);
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned&  u, const sc_uint_base& v);
  SC_SIGNED_SYM sc_signed operator - (const sc_int_base&  u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator - (const sc_uint_base& u, const sc_unsigned&  v);
  SC_SIGNED_SYM sc_signed operator - (const sc_signed&    u, const sc_int_base&  v);
  SC_SIGNED_SYM sc_signed operator - (const sc_signed&    u, const sc_uint_base& v);
  SC_SIGNED_SYM sc_signed operator - (const sc_int_base&  u, const sc_signed&    v);
  SC_SIGNED_SYM sc_signed operator - (const sc_uint_base& u, const sc_signed&    v);
  ...
  SC_SIGNED_SYM sc_signed operator * (const sc_signed&  u, long              v);
  SC_SIGNED_SYM sc_signed operator * (const sc_signed&  u, unsigned long     v);
  inline SC_SIGNED_SYM sc_signed operator * (const sc_signed&  u, int               v);
  inline sc_signed operator * (const sc_signed&  u, unsigned int      v);
  ...
  SC_SIGNED_SYM sc_unsigned operator << (const sc_unsigned&  u, const sc_signed&    v);
    SC_SIGNED_SYM sc_signed operator << (const sc_signed&    u, const sc_unsigned&  v);
  ...
  SC_SIGNED_SYM sc_signed operator + (const sc_signed&   u);
  SC_SIGNED_SYM sc_signed operator - (const sc_signed&   u);
  SC_SIGNED_SYM sc_signed operator - (const sc_unsigned& u);

  // LOGICAL OPERATORS:

  // Logical EQUAL operators:

  SC_SIGNED_SYM bool operator == (const sc_unsigned&  u, const sc_signed&    v);
  SC_SIGNED_SYM bool operator == (const sc_signed&    u, const sc_unsigned&  v);

  SC_SIGNED_SYM bool operator == (const sc_signed&    u, const sc_signed&    v);
  SC_SIGNED_SYM bool operator == (const sc_signed&    u, int64               v);
  SC_SIGNED_SYM bool operator == (const sc_signed&    u, uint64              v);
  SC_SIGNED_SYM bool operator == (const sc_signed&    u, long                v);
  SC_SIGNED_SYM bool operator == (const sc_signed&    u, unsigned long       v);
  inline SC_SIGNED_SYM bool operator == (const sc_signed&    u, int                 v);
  inline bool operator == (const sc_signed&    u, unsigned int        v);

  SC_SIGNED_SYM bool operator == (int64               u, const sc_signed&    v);
  SC_SIGNED_SYM bool operator == (uint64              u, const sc_signed&    v);
  SC_SIGNED_SYM bool operator == (long                u, const sc_signed&    v);
  SC_SIGNED_SYM bool operator == (unsigned long       u, const sc_signed&    v);
  inline bool operator == (int                 u, const sc_signed&    v);
  inline bool operator == (unsigned int        u, const sc_signed&    v);

  SC_SIGNED_SYM bool operator == (const sc_signed&    u, const sc_int_base&  v);
  SC_SIGNED_SYM bool operator == (const sc_signed&    u, const sc_uint_base& v);
  SC_SIGNED_SYM bool operator == (const sc_int_base&  u, const sc_signed&    v);
  SC_SIGNED_SYM bool operator == (const sc_uint_base& u, const sc_signed&    v);
...
class SC_SIGNED_SYM sc_signed_bitref_r : public sc_value_base
{
...
class SC_SIGNED_SYM sc_signed_bitref
...
class SC_SIGNED_SYM sc_signed_subref_r : public sc_value_base
{
    friend class sc_signed;
...
class SC_SIGNED_SYM sc_signed_subref
...
class SC_SIGNED_SYM sc_signed : public sc_value_base
{
