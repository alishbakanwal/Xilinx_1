...
#ifdef _WIN32
#ifdef SC_REPORT_CPP
#define SC_REPORT_SYM SC_EXPORT
#else
#define SC_REPORT_SYM SC_IMPORT
#endif
#else
#define SC_REPORT_SYM 
#endif
...
class SC_REPORT_SYM sc_report : public std::exception
{
...
SC_REPORT_SYM extern const char SC_ID_UNKNOWN_ERROR_[];
SC_REPORT_SYM extern const char SC_ID_WITHOUT_MESSAGE_[];
SC_REPORT_SYM extern const char SC_ID_NOT_IMPLEMENTED_[];
SC_REPORT_SYM extern const char SC_ID_INTERNAL_ERROR_[];
SC_REPORT_SYM extern const char SC_ID_ASSERTION_FAILED_[];
SC_REPORT_SYM extern const char SC_ID_OUT_OF_BOUNDS_[];

// backward compatibility with 2.0+
extern SC_REPORT_SYM const char SC_ID_REGISTER_ID_FAILED_[];
