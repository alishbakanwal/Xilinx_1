...
namespace sc_meta {
  ...
  template< typename T > struct SC_EXPORT remove_const          { typedef T type; };
  template< typename T > struct SC_EXPORT remove_const<const T> { typedef T type; };

  template< typename T, typename U >
  struct SC_EXPORT is_same      { SC_BOOST_STATIC_CONSTANT( bool, value = false ); };
  template< typename T >
  struct SC_EXPORT is_same<T,T> { SC_BOOST_STATIC_CONSTANT( bool, value = true );  };

  template< typename T >
  struct SC_EXPORT is_const           { SC_BOOST_STATIC_CONSTANT( bool, value = false ); };
  template< typename T >
  struct SC_EXPORT is_const< const T> { SC_BOOST_STATIC_CONSTANT( bool, value = true );  };

  template< typename CT, typename T >
  struct SC_EXPORT is_more_const {
  ...
  struct SC_EXPORT special_result {};
  template< typename T > struct remove_special_fptr {};
  template< typename T > 
  struct SC_EXPORT remove_special_fptr< special_result& (*)( T ) >
    { typedef T type; };
...
SC_EXPORT typename Container::iterator
...
class SC_EXPORT sc_vector_base
  : public sc_object
{
...
struct SC_EXPORT sc_direct_access
{
...
template< typename ElementType
        , typename AccessType   >
class SC_EXPORT sc_member_access
{
  public:
...
class SC_EXPORT sc_vector_iter
...
class SC_EXPORT sc_vector_assembly
{
...
template< typename T, typename MT >
SC_EXPORT sc_vector_assembly<T,MT>
...
template< typename T >
SC_EXPORT typename sc_vector<T>::element_type *
