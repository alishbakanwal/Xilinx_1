...
struct SC_EXPORT sc_trace_params
{
    sc_trace_file*        tf;
    std::string      name;
...
SC_EXPORT typedef std::vector<sc_trace_params*> sc_trace_params_vec;
...
template <>
class SC_EXPORT sc_in<sc_dt::sc_logic>
...
template <>
class SC_EXPORT sc_inout<sc_dt::sc_logic>
