...
SC_EXPORT extern const char* sc_copyright();
SC_EXPORT extern const char* sc_release();
SC_EXPORT extern const char* sc_version();

SC_EXPORT extern const unsigned int sc_version_major;
SC_EXPORT extern const unsigned int sc_version_minor;
SC_EXPORT extern const unsigned int sc_version_patch;

SC_EXPORT extern const std::string  sc_version_originator;
SC_EXPORT extern const std::string  sc_version_release_date;
SC_EXPORT extern const std::string  sc_version_prerelease;
SC_EXPORT extern const bool         sc_is_prerelease;
SC_EXPORT extern const std::string  sc_version_string;
SC_EXPORT extern const std::string  sc_copyright_string;
...
#endif
SC_EXPORT extern const int SC_DISABLE_VIRTUAL_BIND_CHECK_;
...
>
struct SC_EXPORT SC_API_VERSION_STRING
{
