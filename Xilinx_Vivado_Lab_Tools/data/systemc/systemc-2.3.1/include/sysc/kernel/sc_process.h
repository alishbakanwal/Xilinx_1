...
#ifdef _WIN32
#ifdef SC_PROCESS_CPP
#define SC_PROCESS_SYM SC_EXPORT
#else
#define SC_PROCESS_SYM SC_IMPORT
#endif
#else
#define SC_PROCESS_SYM 
#endif
...
SC_PROCESS_SYM const char* sc_gen_unique_name( const char*, bool preserve_first );
SC_PROCESS_SYM sc_process_handle sc_get_current_process_handle();
SC_PROCESS_SYM void sc_thread_cor_fn( void* arg );
SC_PROCESS_SYM bool timed_out( sc_simcontext* );

SC_PROCESS_SYM extern bool sc_allow_process_control_corners; // see sc_simcontext.cpp.
...
class SC_PROCESS_SYM sc_process_host 
{
  public:
    sc_process_host() {}
...
class SC_PROCESS_SYM sc_process_monitor {
  public:
    enum {
        spm_exit = 0
    };
...
// COMPILER NOT DOES SUPPORT CAST TO void (sc_process_host::*)() from (T::*)():
    ...
    class SC_PROCESS_SYM sc_process_call_base {
      public:
    ...
    sc_EXPORT extern sc_process_call_base sc_process_defunct;

    template<class T>
    class SC_PROCESS_SYM sc_process_call : public sc_process_call_base {
      public:
...
SC_PROCESS_SYM extern void sc_set_stack_size( sc_thread_handle, std::size_t );
...
//==============================================================================
class SC_PROCESS_SYM sc_throw_it_helper {
  public:
...
class SC_PROCESS_SYM sc_throw_it : public sc_throw_it_helper
{
...
//       
//==============================================================================
class SC_PROCESS_SYM sc_process_b : public sc_object { 
...
//------------------------------------------------------------------------------
struct SC_PROCESS_SYM scoped_flag
{
