...
#ifdef _WIN32
#ifdef SC_TIME_CPP
#define SC_TIME_SYM SC_EXPORT
#else
#define SC_TIME_SYM SC_IMPORT
#endif
#else
#define SC_TIME_SYM 
#endif
...
// friend operator declarations
    ...
    SC_TIME_SYM const sc_time operator + ( const sc_time&, const sc_time& );
    SC_TIME_SYM const sc_time operator - ( const sc_time&, const sc_time& );
    SC_TIME_SYM const sc_time operator * ( const sc_time&, double );
    SC_TIME_SYM const sc_time operator * ( double, const sc_time& );
    SC_TIME_SYM const sc_time operator / ( const sc_time&, double );
    SC_TIME_SYM double        operator / ( const sc_time&, const sc_time& );
    SC_TIME_SYM const sc_time operator % ( const sc_time&, const sc_time& );
...
struct SC_TIME_SYM sc_time_params
{
...
SC_TIME_SYM extern const sc_time SC_ZERO_TIME;


// functions for accessing the time resolution and default time unit

SC_TIME_SYM extern void    sc_set_time_resolution( double, sc_time_unit );
SC_TIME_SYM extern sc_time sc_get_time_resolution();

SC_TIME_SYM extern void    sc_set_default_time_unit( double, sc_time_unit );
SC_TIME_SYM extern sc_time sc_get_default_time_unit();
