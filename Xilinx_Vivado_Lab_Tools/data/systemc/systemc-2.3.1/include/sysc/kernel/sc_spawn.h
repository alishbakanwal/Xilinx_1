...
//=============================================================================
template<typename T>
class SC_EXPORT sc_spawn_object : public sc_process_host {
  public:
...
//------------------------------------------------------------------------------
template <typename T>
inline SC_EXPORT sc_process_handle sc_spawn( 
    T object, 
    const char* name_p = 0,
...
template<typename T>
class SC_EXPORT sc_spawn_object_v : public sc_process_host {
  public:
