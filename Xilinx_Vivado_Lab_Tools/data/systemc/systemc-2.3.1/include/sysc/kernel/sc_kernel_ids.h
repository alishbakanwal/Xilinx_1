...
#ifdef _WIN32
#ifdef SC_UTILS_IDS_CPP
#define SC_KERNEL_ID_SYM SC_EXPORT
#else
#define SC_KERNEL_ID_SYM SC_IMPORT
#endif
#else
#define SC_KERNEL_ID_SYM
#endif
...
#define SC_DEFINE_MESSAGE(id,unused1,unused2) \
    namespace sc_core { extern SC_KERNEL_ID_SYM const char id[]; }
namespace sc_core {
    SC_IMPORT extern const char SC_ID_REGISTER_ID_FAILED_[]; // in sc_report_handler.cpp
}
#endif
