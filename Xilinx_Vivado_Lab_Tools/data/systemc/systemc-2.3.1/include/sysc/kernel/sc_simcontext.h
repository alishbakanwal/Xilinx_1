...
#ifdef _WIN32
#ifdef SC_SIMCONTEXT_CPP
#define SC_SIMCONTEXT_SYM SC_EXPORT
#else
#define SC_SIMCONTEXT_SYM SC_IMPORT
#endif
#else
#define SC_SIMCONTEXT_SYM 
#endif
...
struct SC_SIMCONTEXT_SYM sc_curr_proc_info
{
...
enum SC_SIMCONTEXT_SYM sc_stop_mode {          // sc_stop modes:
    SC_STOP_FINISH_DELTA,
    SC_STOP_IMMEDIATE
};

SC_SIMCONTEXT_SYM extern void sc_set_stop_mode( sc_stop_mode mode );
SC_SIMCONTEXT_SYM extern sc_stop_mode sc_get_stop_mode();
...
SC_SIMCONTEXT_SYM extern void sc_start();
SC_SIMCONTEXT_SYM extern void sc_start( const sc_time& duration, 
                      sc_starvation_policy p=SC_RUN_TO_TIME );
SC_SIMCONTEXT_SYM inline void sc_start( int duration, sc_time_unit unit, 
                      sc_starvation_policy p=SC_RUN_TO_TIME )
{
    sc_start( sc_time((double)duration,unit), p );
}

SC_SIMCONTEXT_SYM inline void sc_start( double duration, sc_time_unit unit, 
                      sc_starvation_policy p=SC_RUN_TO_TIME )
{
    sc_start( sc_time(duration,unit), p );
}

SC_SIMCONTEXT_SYM extern void sc_stop();

// friend function declarations

SC_SIMCONTEXT_SYM sc_dt::uint64 sc_delta_count();
SC_SIMCONTEXT_SYM const std::vector<sc_event*>& sc_get_top_level_events(
				const   sc_simcontext* simc_p);
SC_SIMCONTEXT_SYM const std::vector<sc_object*>& sc_get_top_level_objects(
				const   sc_simcontext* simc_p);
SC_SIMCONTEXT_SYM bool    sc_is_running( const sc_simcontext* simc_p );
SC_SIMCONTEXT_SYM void    sc_pause();
SC_SIMCONTEXT_SYM bool    sc_end_of_simulation_invoked();
SC_SIMCONTEXT_SYM void    sc_start( const sc_time&, sc_starvation_policy );
SC_SIMCONTEXT_SYM bool    sc_start_of_simulation_invoked();
SC_SIMCONTEXT_SYM void    sc_set_time_resolution( double, sc_time_unit );
SC_SIMCONTEXT_SYM sc_time sc_get_time_resolution();
SC_SIMCONTEXT_SYM void    sc_set_default_time_unit( double, sc_time_unit );
SC_SIMCONTEXT_SYM sc_time sc_get_default_time_unit();
SC_SIMCONTEXT_SYM bool    sc_pending_activity_at_current_time( const sc_simcontext* );
SC_SIMCONTEXT_SYM bool    sc_pending_activity_at_future_time( const sc_simcontext* );
SC_SIMCONTEXT_SYM sc_time sc_time_to_pending_activity( const sc_simcontext* );
...
class SC_SIMCONTEXT_SYM sc_simcontext
{
...
#if 1
SC_SIMCONTEXT_SYM extern sc_simcontext* sc_curr_simcontext;
SC_SIMCONTEXT_SYM extern sc_simcontext* sc_default_global_context;

SC_SIMCONTEXT_SYM inline sc_simcontext*
...
SC_SIMCONTEXT_SYM extern sc_process_b* sc_get_curr_process_handle();
...
SC_SIMCONTEXT_SYM inline int sc_get_simulator_status()
{
...
SC_SIMCONTEXT_SYM extern void sc_initialize();

SC_SIMCONTEXT_SYM extern const sc_time& sc_max_time();    // Get maximum time value.
SC_SIMCONTEXT_SYM extern const sc_time& sc_time_stamp();  // Current simulation time.
SC_SIMCONTEXT_SYM extern double sc_simulation_time();     // Current time in default time units.
...
SC_SIMCONTEXT_SYM extern sc_event* sc_find_event( const char* name );

SC_SIMCONTEXT_SYM extern sc_object* sc_find_object( const char* name );
...
SC_SIMCONTEXT_SYM bool sc_is_unwinding();

SC_SIMCONTEXT_SYM inline void sc_pause()
{
...
SC_SIMCONTEXT_SYM inline bool sc_pending_activity_at_current_time
  ( const sc_simcontext* simc_p = sc_get_curr_simcontext() )
{
...
SC_SIMCONTEXT_SYM inline bool sc_pending_activity_at_future_time
  ( const sc_simcontext* simc_p = sc_get_curr_simcontext() )
{
  sc_time ignored;
...
SC_SIMCONTEXT_SYM inline bool sc_pending_activity
  ( const sc_simcontext* simc_p = sc_get_curr_simcontext() )
{
...
SC_SIMCONTEXT_SYM inline bool sc_hierarchical_name_exists( const char* name )
{
...
SC_SIMCONTEXT_SYM extern bool sc_allow_process_control_corners;
