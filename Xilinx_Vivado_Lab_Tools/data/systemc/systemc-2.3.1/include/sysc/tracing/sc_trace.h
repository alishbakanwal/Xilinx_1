...
SC_EXPORT void sc_trace( sc_trace_file* tf,
...
SC_EXPORT extern void sc_trace( sc_trace_file* tf,
		      const void* object,
		      const std::string& name );
...
// ----------------------------------------------------------------------------
// Create VCD file
SC_EXPORT extern sc_trace_file *sc_create_vcd_trace_file(const char* name);
SC_EXPORT extern void sc_close_vcd_trace_file( sc_trace_file* tf );


// ----------------------------------------------------------------------------
// Create WIF file
SC_EXPORT extern sc_trace_file *sc_create_wif_trace_file(const char *name);
SC_EXPORT extern void sc_close_wif_trace_file( sc_trace_file* tf );
