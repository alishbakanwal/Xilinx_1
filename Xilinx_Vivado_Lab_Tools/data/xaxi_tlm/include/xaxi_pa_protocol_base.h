...
namespace xaxi_tlm{
  ...
  public:
    virtual 	void init(	
        ...
        std::queue<xaxi_tlm_transaction*>* p_trans_queue) = 0;
  ...
  public:
    virtual 	void init(	
        ...
        xaxi_tlm_slave_socket* p_slave_socket) = 0;
    virtual void operator()() = 0;
    virtual void transmit_transaction(int socket_id,xaxi_tlm_transaction& trans, tlm::tlm_phase& phase, sc_core::sc_time& t) = 0;
  protected:
  private:
  };
  ...
  public:
    virtual 	void init(	
        ...
        xaxi_tlm_slave_socket* p_slave_socket) = 0;
    virtual void operator()() = 0;
    virtual void transmit_rd_address(int socket_id,xaxi_tlm_transaction& trans, tlm::tlm_phase& phase, sc_core::sc_time& t) = 0;
  protected:
  private:
  };
  ...
  public:
    ...
    virtual void operator()() = 0;
    virtual void transmit_response(int socket_id,
