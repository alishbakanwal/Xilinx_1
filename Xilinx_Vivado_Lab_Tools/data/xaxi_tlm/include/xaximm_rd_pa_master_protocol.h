...
namespace xaxi_tlm{
  ...
  public:
    ...
    void operator()();
  private:
    void transmit_rd_address(int socket_id,xaxi_tlm_transaction& trans, tlm::tlm_phase& phase, sc_core::sc_time& t);
    void set_raddr();
    void set_arid();
    void set_arlen();
    void set_arsize();
    ...
    void set_aruser();
    void set_arregion();
    void sample_rdata(xaxi_tlm_transaction*& trans);
    void sample_ruser(xaxi_tlm_transaction*& trans);
    void sample_rresp(xaxi_tlm_transaction*& trans);
